<%-- 
    ...
    Created on : 27/08/2018,, 02:13:20 PM
                    ...
                    <tr class="tr">                    
                        <td><img src="data:image/jpg;base64,${i}" width="200" height="100" alt="Image not found" /></td>
                            <c:forEach var="v" items="${vehiculos}">
                                ...
                                <td class="tv"><a style="color:white;" class="evt" href="Servlet?action=vender">Vender</a></td>
                                <td class="td"><a style="color:white;" class="evt" onclick="return confirm('Esta seguro?')" href="Servlet?action=deleteCoche&matricula=${v.matricula}">&nbsp;&nbsp;&nbsp;Eliminar</a></td>
                            </c:if>
